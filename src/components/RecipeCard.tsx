    ...
    >
      <div className="relative aspect-[4/3] sm:aspect-[5/4] overflow-hidden bg-muted">
        <RecipeImage
          ...
          imgClassName="w-full h-full object-cover group-hover:scale-105 transition duration-500 motion-reduce:transition-none motion-reduce:group-hover:scale-100"
          showOverlay
          compact
        />
        <span
